...
%let path=D:\CloudStation\partage de adis\_01-TCH-Teacher\_DSTI\202103\2-LWPG2_001-Prog2\Data;
...
*%let path=s:/workshop/pg2;
*%let path=c:/workshop/pg2;
*%let path=c:/SAS_Education/pg2;
*%let path=c:/SAS_Education/lwpg2;
